...
class UnmuteChatCommand : CommandExecutor {
    ...
    override fun onCommand(sender: CommandSender, command: Command, label: String, args: Array<String>): Boolean {
        ...
        Services.punishmentService.isChatMuted = false
        MessageUtils.sendAnnouncement("&fChat has been unmuted by &6${player.name}&f.")
        return true
    }
}